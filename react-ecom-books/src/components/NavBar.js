    ...
    return (
        <div>
            <nav className="nav-container container">
                <div className="row">
                    <div className="col-1">
                        <p className="navbar-item p-2">Booksy</p>
                    </div>
                    <div className="col-6">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                        <a className="dropdown-item" href="#">
                                            Rewards <span><AiOutlineGift /></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="dropdown-item" href="#">
                                            Your wishlist <span><AiFillHeart /></span> 
                                        </a>
                                    </li>
                                    <li>
                                        <a className="dropdown-item" href="#">
                                            Orders <span><BsFillBagCheckFill /></span> 
                                        </a>
                                    </li>
                                    <li>
                                        <a className="dropdown-item" href="#">
                                            Transactions <span><TbStack2 /></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="dropdown-item" href="#">
